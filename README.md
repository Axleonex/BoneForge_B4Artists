...
- **[`BoneForge-BFA-8.5.1.zip`](https://github.com/Axleonex/BoneForge_B4Artists/raw/main/releases/BoneForge-BFA-8.5.1.zip)** — or grab it from the [Releases](../../releases) page.
...
2. Pick `BoneForge-BFA-8.5.1.zip`.
...
| Release zip | `BoneForge-8.5.1.zip` | `BoneForge-BFA-8.5.1.zip` |
