...
- **[`BoneForge-BFA-8.5.10.zip`](https://github.com/Axleonex/BoneForge_B4Artists/raw/main/releases/BoneForge-BFA-8.5.10.zip)** — or grab it from the [Releases](../../releases) page.
...
> that is the exclusivity lockout working as designed, not a bug.

To install in **Bforartists**:

1. **Edit → Preferences → Add-ons → Install from Disk…**
2. Pick `BoneForge-BFA-8.5.10.zip`.
...
| Release zip | `BoneForge-8.5.10.zip` | `BoneForge-BFA-8.5.10.zip` |
